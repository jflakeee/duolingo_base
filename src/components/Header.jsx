...
export default function Header({ progress }) {
  const goal = progress.dailyGoal || DAILY_GOAL
  const goalPct = Math.min(100, Math.round((progress.dailyXp.amount / goal) * 100))
  return (
    <div className="header">
      ...
      <div className="progress" title={`오늘 목표 ${progress.dailyXp.amount}/${goal} XP`}>
